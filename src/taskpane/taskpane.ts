...
const exportFinishedExamBtn = document.getElementById("exportExam") as HTMLButtonElement;
...
Office.onReady((info) => {
  if (info.host === Office.HostType.Word) {
    ...
    exportFinishedExamBtn.onclick = exportFinishedExam;
...
export async function run() {
  return Word.run(async (context) => {
    ...
    const paragraph = context.document.body.insertParagraph("DEMO CONTENT", Word.InsertLocation.end);
...
export async function exportFinishedExam() {}
